            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <h2 className="text-lg font-semibold text-slate-900 dark:text-white">
                  {filteredAndSortedItems.length} {filteredAndSortedItems.length === 1 ? t.learning.topic : t.learning.topics}
                </h2>
              </div>
            </div>
        ...
        <>
          <div className="grid gap-6 md:grid-cols-2">
            {paginatedItems.map(({ item, postCount }) => (
              <TopicCard key={item.id} item={item} postCount={postCount} type="learning" />
            ))}
          </div>

          {/* Related Categories */}
          <RelatedCategories currentCategory={activeCategory} type="learning" />
