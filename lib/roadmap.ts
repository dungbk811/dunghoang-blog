...
export const cooRoadmap: RoadmapItem[] = [
  ...
  {
    id: 'project-estimation-quotation-work',
    title: 'Quy trình estimate và báo giá dự án',
    description: 'Xây dựng quy trình estimate và báo giá chuẩn hóa: estimation techniques, quotation templates, workflow approval, time tracking. Đảm bảo accuracy và consistency trong pricing',
    category: 'Phát Triển Kinh Doanh',
  ...
  {
    id: 'project-cost-roi-analysis-work',
    title: 'Phân tích chi phí và ROI dự án',
    description: 'Phân tích chi phí dự án: cost breakdown structure, direct vs indirect costs, margin analysis, ROI calculation. Đánh giá profitability và decision-making cho pricing',
    category: 'Quản Lý Tài Chính',
    subcategory: 'Định Giá & Lợi Nhuận',
    status: 'in-progress',
    level: 'intermediate',
